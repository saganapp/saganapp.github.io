...
interface TileGroups {
  ...
  highlightedPath: string; // 2% of tiles, primary color fill+stroke
}
...
function buildTileGroups(
  ...
  for (let row = -1; row < rows; row++) {
    for (let col = -1; col < cols; col++) {
      ...
      const density = gutterDensity(cx, width, contentRatio);
  ...
  return (
    ...
    >
      ...
      >
        ...
        {/* 2% highlighted — primary color, solid fill + bolder stroke */}
